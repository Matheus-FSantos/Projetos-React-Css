<header>
  <h1 align="center"><em>Contador</em></h1>
</header>

<section>
  <h6 align="center">Sobre:</h6>
  <p>
    Espaço destinado para postagem do Terceiro projeto do repositório, onde, foi escrito utilizando framework ReactJS e estilizado usando a ferramenta de estilização CSS, feito para treinar um pouco mais sobre 'Componets' em JSX e para treinar tambem mais um pouco sobre a ferramenta CSS
  </p>
</section>
